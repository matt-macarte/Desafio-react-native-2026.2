	...
	return (
		<View style={[layouts.dadContainer, styles.container]}>
			...
			<Image
				...
				style={styles.logo}
			/>
			<Text style={txtStyles.h1}>Cadastro</Text>
			...
			<View style={styles.inputContainer}>
				...
				<View style={styles.inputItem}>
					<Text style={txtStyles.p}>Confirmar Senha</Text>
					<Input placeholder="Digite sua senha novamente" />
				</View>
			</View>

			<Button label="Cadastrar" onPress={handleEnter} />

			<TouchableOpacity
				onPress={() => router.replace("/login")}
				style={styles.registerLink}
			>
				<Text style={txtStyles.p}>Já tem conta?</Text>
				<Text style={[txtStyles.p, styles.link]}>Faça o login</Text>
